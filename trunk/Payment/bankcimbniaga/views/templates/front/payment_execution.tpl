...
<p style="margin-top:20px;">
	- {l s='The total amount of your order is' mod='bankcimbniaga'}
	<span id="amount" class="price">{displayPrice price=$total}</span>
	{if $use_taxes == 1}
    	{l s='(tax incl.)' mod='bankcimbniaga'}
    {/if}
</p>
<p>
	-
...
<p class="cart_navigation">
	<input type="submit" name="submit" value="{l s='I confirm my order' mod='bankcimbniaga'}" class="exclusive_large" />
	<a href="{$link->getPageLink('order', true, NULL, "step=3")}" class="button_large">{l s='Other payment methods' mod='bankcimbniaga'}</a>
</p>
</form>
{/if}
